    	...
    	<div class="well-smoke block" style="margin-top:0px">
			...
			<div class="row-fluid form-horizontal">
				<div class="control-group" >
			    	<label class="control-label"><?php _e("Your Email Address :", bookings_plus); ?>
		                <span class="req">*</span>
		            </label>
					<div class="controls">
			    ...
			    <label class="control-label"><?php _e("Subject :", bookings_plus); ?>
		         				<span class="req">*</span>
			          			...
			          			<div class="control-group" >
									...
									<div class="controls">
										...
										<?php 
    				  						wp_editor($content, $id = 'uxAffiliate', $prev_id = 'title', $media_buttons = true, $tab_index = 1); 
    									?>
									</div>
		          	  			</div>          	
		   				...
		   				<div class="form-actions" style="padding:10px">
		    				<input type="submit" value="<?php _e("Send Email", bookings_plus); ?>" class="btn btn-danger pull-right">
		   				</div> 
	           	</div>
	           		</form>
	           		<style type="text/css">
...
({
	...
	submitHandler: function(form) 
	{
		...
		if (jQuery("#wp-uxAffiliate-wrap").hasClass("tmce-active"))
		{
    		var uxReportBug  = encodeURIComponent(tinyMCE.get('uxAffiliate').getContent());
    	}
    	else
    	{
    		var uxReportBug  = encodeURIComponent(jQuery('#uxAffiliate').val());
    	}
